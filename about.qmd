...
- project and product planning for improving the statewide inventory methods, developing a SQL database for historic emissions data, and creating a pubic-facing interactive dashboard
...
- co-authoring a legislative report on whether Washington should adjust its emission reduction targets based on emerging climate science. We are aiming to publish this report by May 2025.
